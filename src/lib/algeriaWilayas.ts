// Algeria 58 wilayas with all 1,541 communes
...
export const ALGERIA_WILAYAS: Record<string, string[]> = {
  ...
  Tamanrasset: ["Abelsa", "Ain Amguel", "Idles", "Tamanrasset", "Tazrouk"],
  Tébessa: [
    "Ain Zerga",
    "Bedjene",
    "Bekkaria",
  ...
  "In Salah": ["Ain Salah", "Foggaret Ezzoua", "Inghar"],
  "In Guezzam": ["Ain Guezzam", "Tin Zouatine"],
  Touggourt: [
    "Benaceur",
    "Blidet Amor",
    "El Alia",
  ...
  Djanet: ["Bordj El Haouass", "Djanet"],
  "El M'Ghair": [
    "Dijel",
    "Djamaa",
    "El M'Ghair",
...
export const WILAYA_LIST = Object.keys(ALGERIA_WILAYAS);
...
export const ALGERIA_GEO: WilayaEntry[] = ALGERIAN_WILAYAS.map((wilaya, i) => ({
  code: i + 1,
  wilaya,
  cities: ALGERIA_WILAYAS[wilaya] ?? [wilaya],
}));
...
export function isValidAlgerianPhone(phone: string): boolean {
  ...
  return (
    /^(?:\+213|0)(?:5|6|7)\d{8}$/.test(cleaned) || /^(?:\+213|0)(?:2|3|4)\d{7,8}$/.test(cleaned)
  );
}
