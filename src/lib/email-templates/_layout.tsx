...
export const BrandedLayout = ({ preview, eyebrow, children }: BrandedLayoutProps) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      ...
      <table width="100%" cellPadding={0} cellSpacing={0} role="presentation" style={outerTable}>
        <tbody>
          <tr>
            <td align="center" style={{ padding: "40px 16px" }}>
              <Container style={container}>
                ...
                <Section style={hero}>
                  <Img src={LOGO_URL} alt="Fennecly" width="48" height="48" style={logoMark} />
                  <Text style={heroBrand}>Fennecly</Text>
                  <Text style={heroTagline}>The all-in-one e-commerce platform for Algeria</Text>
                </Section>
                ...
                <Section style={footer}>
                  ...
                  <Text style={footerCopy}>
                    © {new Date().getFullYear()} Fennecly · Built with ♥ for Algerian merchants
                  </Text>
                  <Text style={footerLinks}>
                    ...
                    <span style={footerDot}>·</span>
                    <Link href={`${SITE_URL}/privacy`} style={footerSmallLink}>
                      Privacy
                    </Link>
                  </Text>
                </Section>
