...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    description: "Desert-inspired warmth with gold accents on deep earth tones. Perfect for jewelry, leather goods, and luxury items.",
    ...
    heroSubheading: "Handcrafted treasures from the heart of Algeria. Each piece tells a story of tradition and elegance.",
  ...
  },
  {
    ...
    description: "Cool blues and whites inspired by the Algerian coast. Ideal for fashion, home decor, and lifestyle brands.",
    ...
    heroSubheading: "Mediterranean-inspired fashion and lifestyle. Fresh designs for the modern Algerian.",
  ...
  },
  {
    ...
    description: "Clean white architecture with blue accents, inspired by Algiers' iconic Casbah. Perfect for home goods and artisan crafts.",
    niche: "Home / Artisan / Crafts",
    accent: "#1E40AF",
    highlights: ["White & blue palette", "Geometric patterns", "Architectural feel", "Minimal elegance"],
    layout: "casbah",
    patch: {
      theme: "casbah",
  ...
  },
  {
    ...
    description: "Forest greens and warm browns inspired by the Atlas Mountains. Perfect for organic, wellness, and nature brands.",
    ...
    heroSubheading: "Organic products from the heart of the Atlas Mountains. Pure, natural, sustainable.",
    heroCta: "Go Natural",
  },
  {
    id: "tlemcen",
    ...
    description: "Rich reds and golds inspired by Tlemcen's ornate Islamic architecture. Perfect for luxury fashion and traditional crafts.",
    ...
    heroSubheading: "Ornate craftsmanship passed down through generations. Luxury woven into every thread.",
  ...
  },
  {
    ...
    description: "High contrast black and white with dramatic accents, inspired by Constantine's legendary bridges and gorges.",
  ...
  },
  {
    ...
    description: "Crisp white with Mediterranean blue accents. Clean, modern, and sophisticated. Perfect for fashion and beauty.",
    ...
    heroSubheading: "Modern Mediterranean style for the confident Algerian woman. Clean, elegant, effortless.",
  ...
  },
  {
    ...
    description: "Deep blue and white inspired by Ghardaia's M'zab valley. Minimalist desert aesthetic for home and lifestyle.",
    ...
    heroSubheading: "Handcrafted home goods inspired by the blue city of Ghardaia. Minimal, serene, timeless.",
  ...
  },
  {
    ...
    description: "Terracotta reds and ochre yellows inspired by Kabyle Berber pottery and textiles. Authentic and warm.",
    ...
    heroSubheading: "Handcrafted with centuries of Kabyle tradition. Every piece carries the spirit of the mountains.",
  ...
  },
  {
    ...
    description: "Sleek black and white with gold accents. Modern cosmopolitan feel for tech, fashion, and premium brands.",
    niche: "Tech / Premium Fashion / Accessories",
    accent: "#CA8A04",
    highlights: ["Black & gold luxury", "Modern sans-serif", "Cosmopolitan feel", "Premium spacing"],
    layout: "algiers",
    patch: {
      theme: "algiers",
    ...
    heroSubheading: "Modern essentials for cosmopolitan Algeria. Premium quality, contemporary design.",
