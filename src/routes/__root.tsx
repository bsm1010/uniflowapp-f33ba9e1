...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      // Core fonts (Inter, Space Grotesk, Tajawal) are already imported in styles.css.
      // Theme-preset fonts are loaded on demand from storeTheme to avoid blocking initial paint.
    ],
  }),
