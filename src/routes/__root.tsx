...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "e-web" },
      { name: "description", content: "e-web.site is a new e-commerce store's builder" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "e-web" },
      { property: "og:description", content: "e-web.site is a new e-commerce store's builder" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "e-web" },
      { name: "twitter:description", content: "e-web.site is a new e-commerce store's builder" },
