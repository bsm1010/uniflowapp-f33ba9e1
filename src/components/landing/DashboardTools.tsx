...
export function DashboardTools() {
  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      <div className="absolute top-0 right-0 w-72 h-72 bg-violet-400/10 dark:bg-violet-500/10 rounded-full backdrop-blur-[50px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-fuchsia-400/10 dark:bg-fuchsia-500/10 rounded-full backdrop-blur-[50px] pointer-events-none" />
