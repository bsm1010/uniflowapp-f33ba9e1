    ...
    <section id="how" className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4">
        ...
        <div className="mt-20 relative">
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-violet-400/30 dark:via-violet-500/30 to-transparent -translate-y-1/2" />
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {stepKeys.map((s, i) => (
              ...
              >
                ...
                <div className="rounded-3xl border border-border/60 bg-card/60 p-8 text-center hover:shadow-2xl transition-all duration-500">
