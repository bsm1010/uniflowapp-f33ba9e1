...
export function Features() {
  ...
  return (
    <section id="features" className="py-20 md:py-28 relative">
      <div className="absolute top-1/2 left-0 w-72 h-72 bg-violet-400/5 dark:bg-violet-500/5 rounded-full pointer-events-none" />
      <div className="absolute top-1/3 right-0 w-72 h-72 bg-fuchsia-400/5 dark:bg-fuchsia-500/5 rounded-full pointer-events-none" />
