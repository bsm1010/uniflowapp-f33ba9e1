...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="py-20 md:py-28 relative">
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-violet-400/10 dark:bg-violet-500/10 rounded-full blur-[120px] pointer-events-none hidden md:block" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-fuchsia-400/10 dark:bg-fuchsia-500/10 rounded-full blur-[120px] pointer-events-none hidden md:block" />
