        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-2">
            <Link to="/s/$slug" params={{ slug }}>
              <span className="text-xl font-bold font-display" style={{ color: t.fg }}>
                {brand}
              </span>
            </Link>
            <p className="mt-3 text-sm max-w-sm leading-relaxed" style={{ color: t.muted }}>
              {tagline}
            </p>
          ...
          {groups.map((group) => (
            <div key={group.title}>
              <h4 className="text-sm font-semibold mb-3" style={{ color: t.fg }}>
                {group.title}
              </h4>
